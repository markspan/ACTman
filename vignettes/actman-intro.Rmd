...
Read the paper: the [publisher's version](https://doi.org/10.1016/j.jsams.2019.11.009)
requires access; an [open-access copy is available via the University of
Groningen's Pure repository](https://pure.rug.nl/ws/files/123896013/1_s2.0_S1440244019302877_main.pdf).
...
mood-state transitions in actigraphy data (Kunkels et al., 2021, 2023),
though see Helmich et al. (2024) for a critical perspective on the
current evidence for this use.
