...
ACTman manages actigraphy data whilst offering pre-processing and
analyses options. This initial version supports the 'Actiwatch 2' and
'MotionWatch 8' actigraphy devices, whilst allowing for both sleep and
...
``` r
ACTman(
  workdir = "C:/Bibliotheek/Studie/PhD/Publishing/ACTman/R-part/mydata",
...
if iwantsleepanalysis, this returns the sleepdata overview, else if
movingwindow, it returns the moving window results, and otherwise it
returns the actdata overview.
